...
void push_theta_gamma_3D(Domain *D,int iteration)
{
    int i,j,N,ii,jj,s,h,harmony,nx,ny,order;
    int startI,endI,minI,maxI,sliceI;
    LoadList *LL;
    double complex U[D->harmony],compVal,expITh;
    double dz,dx,dy,ku,ks,kx,ky,K0,K,xi,ar[D->harmony],psi[D->harmony];
    double x,y,z,px,py,gamma,theta,invGam,minX,minY,wakeE;
    double coef,JJ[D->harmony],J1,J2,wx[2],wy[2],sumTh,sumGam;
    double k1,k2,k3,k4,l1,l2,l3,l4,tmp,dPhi,invBeta;
    ptclList *p;
